...
class _ThemeBottomSheetState extends ConsumerState<ThemeBottomSheet> {
        ...
        child: SafeArea(
          ...
          child: Column(
            ...
            children: [
              ...
              // Theme color buttons
              _buildThemeButtons(readingSettings, textColor, isDark),
      ...
      children: [
        GestureDetector(
          ...
          child: Container(
            ...
            child: Icon(isDark ? Icons.dark_mode : Icons.light_mode, color: variant.primaryColor, size: 24),
          ),
        ),

        const SizedBox(width: 16),
        // Slider track with dynamic border radius
        Expanded(
          child: SliderTheme(
            data: SliderThemeData(
              ...
              activeTrackColor: variant.primaryColor.withValues(alpha: 0.6),
              inactiveTrackColor: variant.backgroundColor,
            ),
            child: Slider(
              value: _brightness,
              min: 0.0,
  ...
  Widget _buildThemeButtons(ReadingSettingsState readingSettings, Color textColor, bool isDark) {
    return Row(
      mainAxisAlignment: MainAxisAlignment.spaceBetween,
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  color: isSelected
                      ...
                      : (isDark ? variant.backgroundColor : Colors.grey[100]),
                  borderRadius: BorderRadius.circular(12),
                  border: Border.all(
                    color: isSelected
                        ? isDark
                              ? variant.primaryColor.withValues(alpha: 0.5)
                              : variant.primaryColor
                        : (readingSettings.isDarkMode ? Colors.grey[700]! : Colors.grey[300]!),
